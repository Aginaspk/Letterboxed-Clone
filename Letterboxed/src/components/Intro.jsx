    ...
    return (
        <div className='w-full flex flex-col items-center xl:relative xl:h-screen xl:mb-[64px]'>
            <div className='xl:w-[1200px] w-full xl:h-[600px] overflow-hidden relative'>
                ...
                <img className='w-full h-full object-cover' src="https://res.cloudinary.com/dup1lh7xk/image/upload/v1745159847/sinners-1200-1200-675-675-crop-000000_ltry9r.jpg" alt="Movie Image" />
            </div>
