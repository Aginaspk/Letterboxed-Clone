...
function FeatureCard({item}) {
    ...
    return (
        <div className='rounded-sm shadow-[inset_0_0_1px_1px_rgba(20,24,28,0.125)] relative flex justify-center items-center cursor-pointer' onClick={()=>navigate(`/filims/${item?._id}`)} onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)}>
