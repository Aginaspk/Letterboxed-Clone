...
function ListCard({ item }) {
    ...
    return (
        <div className={`w-full mb-[25px] ${isFlex && "flex gap-5"}`}>
            <div className={` flex flex-row items-center h-[110px] ${isFlex && "w-[253px]"} rounded-sm border-2 transition-all duration-200 overflow-hidden ${isAuth ? "border-transparent hover:border-white" : "border-transparent hover:border-[#00E054]"}`}>
