...
function Guide() {
  return (
    <div className='w-full grid grid-cols-3 gap-2 '>
        ...
        <div className='flex relative shadow-[inset_0_1px_0_hsla(0,0%,100%,0.1)] bg-[#445566]  hover:bg-[#EE7000] text-[#DDEEFF] text-[14px] font-medium gra px-5 py-4.5 rounded-sm justify-center items-center'>
        ...
        <div className='flex relative shadow-[inset_0_1px_0_hsla(0,0%,100%,0.1)] bg-[#445566]  hover:bg-[#209CE4] text-[#DDEEFF] text-[14px] font-medium gra px-5 py-4.5 rounded-sm justify-center items-center'>
        ...
        <div className='flex relative shadow-[inset_0_1px_0_hsla(0,0%,100%,0.1)] bg-[#445566]  text-[#DDEEFF] hover:bg-[#209CE4] text-[14px] font-medium gra px-5 py-4.5 rounded-sm justify-center items-center'>
