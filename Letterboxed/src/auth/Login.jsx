...
function Login({ closeLogin }) {
  ...
  return (
    <div className='w-auto rounded-b-sm pr-5 pl-2 h-[72px] bg-[#14181C] flex gap-4 justify-center items-center xl:ml-28 '>
      ...
      <div className='pt-3'>
        <button className='px-[12px] text-[12px] rounded-sm font-semibold py-[6px] bg-[#00ac1c] shadow-[inset_0_1px_0_hsla(0,0%,100%,0.3)] text-white gra' onClick={handleLogin}>SIGN IN</button>
      </div>
    </div>
  )
}
